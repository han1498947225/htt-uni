				...
				<view class="sec-tab-content" v-for="item,index in sectionList" :key="item.id">
					...
					<ul>
						<li v-for="child,i in item.sectionList" :key="child.id" @click="openVideo(child)">
							<view class="left">
								<image src="../../static/images/youjianto.png" mode=""></image>
			...
			<view class="thr-tab" v-show="currentId==2">
				<view class="thr-tab-item" v-for="item in commentList" :key="item.id">
					<view class="top">
						...
						<image class="flower" v-if="!item.isGood" src="../../static/images/hei.png" mode="">
						</image>
						<image class="flower" v-else src="../../static/images/hong.png" mode=""></image>
					</view>
					<view class="content">
						{{ item.content }}
					</view>
